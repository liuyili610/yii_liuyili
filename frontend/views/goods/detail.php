			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                            ...
                            <img src="<?='/'.$good->images[0]->path?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php
                                foreach (\frontend\models\GoodsGallery::find()->where(['goods_id' => $goodContent->goods_id])->all() as $k=>$v):
                                ?>
								<li class="<?=$k==0?"cur":""?>">
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?=date('Y-m-d H',$good->inputtime)?></li>
